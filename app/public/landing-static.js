...
(function () {
  ...
  const COPY = {
    zh: {
      ...
      ctaPrimary: "免费进入终端", ctaGhost: "看它怎么工作",
      ...
      f1p: "不是泛泛的 AI 回答。每个结论都来自 KOL 本人的历史推文，逐句标注 [T#]，点开就是原文。",
    ...
    en: {
      ...
      ctaPrimary: "Open the terminal free", ctaGhost: "See how it works",
      ...
      f1p: "Not generic AI answers. Every conclusion comes from the KOL's own tweets, tagged [T#] sentence by sentence — tap to read the original.",
